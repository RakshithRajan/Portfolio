...
import "../styles/horx.css";

gsap.registerPlugin(ScrollTrigger);

function Projects() {
  useEffect(() => {
    // Define the scrollTween for horizontal scrolling
    const scrollTween = gsap.to(".container", {
      xPercent: -100 * (document.querySelectorAll(".panel").length - 1),
      ease: "none",
      scrollTrigger: {
        trigger: ".container",
        pin: true,
    ...
    // Define individual animations for each box
    gsap.to(".box-1", {
      y: -130,
      duration: 2,
      ease: "elastic",
  ...
  onToggle: self => console.log("active", self.isActive)
      ...
      <header>
        <a href="https://greensock.com/scrolltrigger">
          <img className="greensock-icon" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/16327/scroll-trigger-logo-light.svg" width="200" height="64" alt="GreenSock ScrollTrigger" />
        </a>
      </header>
    </>
  );
